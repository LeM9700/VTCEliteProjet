...
const Chatbot = () => {
    ...
    const handleResponse = async (response) => {
        ...
        setTimeout(async () => {
            if (step === 1) {
                ...
                setReservation({ ...reservation, hour: response });
                ...
                else {setReservation({ ...reservation, date: response });
                ...
                if (!validatePhoneNumber(formattedPhone)) {
                    ...
                    try {
                        ...
                        console.log("Requête d'authentification envoyée avec la clé API", auth.config.apiKey);
                ...
                window.confirmationResult.confirm(response)
                    .then(result => {
    ...
    return (
        <div className="chat-container">
            ...
            ) : (step === 1 || step === 3 ||step === 4||step === 5 || step === 6 || step === 7 ||step === 8 || step === 11 || step === 13 || step === 14) ? (
